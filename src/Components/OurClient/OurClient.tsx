    ...
    return (
        <div className='px-4 md:px-auto md:container md:mx-auto'>
            ...
            <div className="relative w-full overflow-hidden mt-2 md:mt-3 lg:mt-4">
                <Marquee pauseOnHover className="[--duration:25s] py-[25px] md:mx-[70px] lg:mx-[144px]">
                ...
                <div className="pointer-events-none absolute inset-y-0 left-0 lg:ml-[144px] md:ml-[70px] w-1/3 bg-gradient-to-r from-white dark:from-background" />
                <div className="pointer-events-none absolute inset-y-0 right-0 lg:mr-[144px] md:mr-[70px] w-1/3 bg-gradient-to-l from-white dark:from-background" />
            </div>
        </div>
    )
}
